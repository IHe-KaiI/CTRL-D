...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    if cam_info.edit_image is not None:
        resized_image_edit = PILtoTorch(cam_info.edit_image, resolution)
        edit_image = resized_image_edit[:3, ...]
    else:
        edit_image = None
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T,
                  ...
                  depth=cam_info.depth, edit_image=edit_image)
